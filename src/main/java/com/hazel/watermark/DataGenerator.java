...
public interface DataGenerator<T> extends Serializable, Iterator<T> {
     ...
     *
     * @param name The state of {@link DataGenerator} should related to this name, make sure the
     *     name of state is different.
     */
    void open(String name, FunctionInitializationContext context, RuntimeContext runtimeContext)
            throws Exception;
